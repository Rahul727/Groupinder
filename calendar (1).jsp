...
<head>
    ...
    $(document).ready(function() {
		...
		${current_reminder.note_title}
		${current_reminder.hours}
		${current_reminder.minutes}		
		${current_reminder.date}		
		</c:forEach>*/
		
		  var formattedEventData = [];
 <%--        <%
        System.out.println("size:"+reminders.size());
        ...
        <%}%> --%>
/* 	         <c:forEach items="${reminders}" var="current_reminder">
/*		 	hour.push('${current_reminder.hours}');
			minutes.push('${current_reminder.minutes}');
	...
	*/		<c:forEach items="${reminders}" var="current_reminder">
			...
			formattedEventData.push({
				title: 'Meeting',
	        	start: new Date(y, m,d,'${current_reminder.hours}','${current_reminder.minutes}'),
	        	allDay: false,
	    	});
                       ...
                       <a href="#"><i class="fa fa-pencil-square-o"></i>   
                        ...
                        <ul class="nav nav-second-level">
	                     ...
	                     <c:forEach items="${notes}" var="note">	
	                  	...
	                  	<a href="FetchEventsReminderServlet"><i class="fa fa-calendar"></i>
										...
										<div class="container">
									        ...
									        <div class="control-group" id="fields">
									            <div class="controls" id="field">
							                    	...
							                    	<input type="text" class="input" id="field1" placeholder="Content" name="noteContent" ><input type="datetime-local" name="daytime">	                    	
