...
public class createNoteDAO {
	...
	public static Note create(Note new_note,User user) {
		...
		try{
			...
			// now we have new note id. we can now insert in the database. but first we need list id.
			...
			String mapUser = "INSERT INTO `collaborators` VALUES('"+note_id+"', '"+userID+"','"+1+"');"; //1 is access right. 1 = modify.
