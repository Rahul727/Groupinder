 ...
 * Date written: 07/05/2017. (mm/dd/yyyy)
	...
	<div class="middle-box text-center">
		<div>		
			<form name="myform" class="m-t" role="form" action="RegisterServlet" method="post">
				...
				<br><button type="submit" class="btn btn-primary block full-width m-b" onclick="validate()">Register</button>

				<p class="text-muted text-center"> <small>Already having a Groupinder account ?</small> </p>
				<a class="btn btn-sm btn-white btn-block" href="index.jsp">Login</a>
			</form>
		</div>
	</div>
			<!-- @authors Rahul_Chhapgar, Darshan_Patel 
				 Form *version-2* 07/09/2017 (mm/dd/yyyy)	-->
</body>
</html>