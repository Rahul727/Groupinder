...
<head>
	...
	<style type="text/css">
		...
		/* input fields */
		input[type=text], datetime-local {	width: 40%;	 padding: 3px 10px;	 margin: 3px 3px;	border: 1px solid #ccc;	box-sizing: border-box;	}
		
		/* buttons */
		button {	background-color: #4CAF50;	color: white;	border: none;	cursor: pointer;	}
		
		button:hover {	opacity: 0.8; }		
		.notebtn   { padding: 10px 18px; 	}		
		.cancelbtn { padding: 10px 18px;  background-color: #f44336;  }		
		...
		.modal {
			...
			overflow: auto; padding-top: 60px;
			background-color: rgb(0, 0, 0);		background-color: rgba(0, 0, 0, 0.4); 			
		}
		.modal-content {  background-color: #fefefe;	margin: 10% 10% 10% 10%;	border: 1px solid #888; }
		
		/* The Modal1 (background) */
		.modal1 {
			display: none; 	z-index: 1;		 overflow: auto;	padding-top: 60px;
			background-color: rgb(0, 0, 0);  background-color: rgba(0, 0, 0, 0.4); /* Black w/ opacity */		
		}
		.modal-content1 {  background-color: #fefefe;	margin: -10% 10% 10% 10%; 	border: 1px solid #888;  }
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">                        
                        <div class="logo-element"><a href="user.jsp">G</a></div>
                    <li>
                       ...
                       <a href="#"><i class="fa fa-pencil-square-o"></i>   
                        ...
                        <ul class="nav nav-second-level">
                          ...
                          <!--    <li><a onclick="document.getElementById('').style.display='block'" >Create</a></li> -->
	                     ...
	                     <c:forEach items="${notes}" var="note">	
	                  	...
	                  	<a href="/Groupinder/FetchEventsReminderServlet"><i class="fa fa-calendar"></i>
       ...
       <div class="wrapper wrapper-content">
						...
						<div id="note${note_count}" class="col-lg-6">
							...
							<div class="ibox">							
								...
								<div id="delete${note_count}" class="modal">
									...
									<h4>
										<a onclick="document.getElementById('CreateNote${note_count}').style.display='block'">
										${current_note.title} </a>
									</h4>
									
									<div align="right">
										<a onclick="document.getElementById('CreateReminder${note_count}').style.display='block'"><i class="fa fa-bell-o"></i> </a>
										<a onclick="document.getElementById('delete${note_count}').style.display='block'"> 
								...
								<div id="CreateNote${note_count}" class="modal">
									<form class="modal-content" action="EditNoteServlet" method="get">
										<div class="container">
										<input type="hidden" name="noteID" value="${current_note.noteID}">
											<input type="text" class="input" placeholder="Title" name="noteTitle" value="${current_note.title}"> <br>
											<c:forEach items="${current_note.content}" var="current_content">
								...
								<div id="CreateReminder${note_count}" class="modal">
									...
									<a onclick="document.getElementById('addCollaborator${note_count}').style.display='block'"><img alt="add member" class="img-circle" src=""></a>
		...
		<div id="userEdit" class="modal text-center">
			<div>		
				<form name="myform" class="m-t modal-content" role="form" action="UpdateUserServlet" method="post">
					...
					<br><button onclick="document.getElementById('userEdit').style.display='none'"  type="submit" class="btn btn-primary block full-width m-b" onclick="validate()">Save</button>
				</form>
			</div>
		</div>
		...
		<div id="CreateReminder" class="modal">
			<form class="modal-content" action="" method="post">
				<div class="container">
					<input type="text" class="input" placeholder="Title" name="title"> <br>
		...
		<div class="footer">
			<div> <strong>Groupinder</strong>&copy; 2017 </div>
		</div>           
